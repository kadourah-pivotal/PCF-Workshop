...
namespace Steeltoe.CloudFoundry.Connector.EF6Autofac
{
    public static class SqlServerDbContextContainerBuilderExtensions
    {
        ...
        public static IRegistrationBuilder<object, SimpleActivatorData, SingleRegistrationStyle> RegisterDbContext<TContext>(this ContainerBuilder container, 
            IConfiguration config, string serviceName = null)
        {
            if (container == null)
            {
